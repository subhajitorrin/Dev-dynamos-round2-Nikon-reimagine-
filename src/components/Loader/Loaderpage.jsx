    ...
    return (
      <>
        {true && (
          <div
            id="mainloadercontainer"
            className=" loadCon w-screen h-screen z-[999999999999] text-white fixed flex flex-col items-center justify-center bg-[#010413] gap-4"
          >
            <div className="NIK text-[6rem] font-bold">NIKON</div>
            <div className="h-[50px] flex flex-col gap-[10px] items-center w-full relative top-[5%] ">
              {islaoding ? (
                <>
                  <p>{counter}%</p>
