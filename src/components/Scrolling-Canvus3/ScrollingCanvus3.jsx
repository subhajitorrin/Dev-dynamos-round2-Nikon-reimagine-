        ...
        <Scene duration="500%" triggerHook="onLeave" pin>
          {(progress) => (
            <div style={{ height: "100vh", position: "relative",width:"100vw" }}>
              ...
              <div
                className="text-overlay md:w-[60%] w-full absolute top-[10%] left-0 text-white flex flex-col items-center md:ml-[22%] md:leading-[3.5rem] p-[1rem] md:p-[0]"
                style={{
              ...
              >
                <h1 className="text-[1.5rem] md:text-[3rem] font-bold uppercase flex flex-wrap gap-[0.5rem]">
