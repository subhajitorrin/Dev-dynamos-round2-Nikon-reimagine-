...
const Img1 =
  "https://res.cloudinary.com/difxhccup/image/upload/v1721918564/nikon_product_angles_1380x1380_1_2-removebg-preview_qbzbva.png";
const Img2 =
  "https://res.cloudinary.com/difxhccup/image/upload/v1721918564/white_hero_2_1_3_2-removebg-preview_prabla.png";
const Img3 =
  "https://res.cloudinary.com/difxhccup/image/upload/v1721919218/img1_t7bgza.png";
        ...
        <div className="mainHero">
              ...
              >
                ...
                <SwiperSlide className="Slide">
                  ...
                  <div className="w-[70%] h-[80%] SwiperDiv flex items-center justify-center relative overflow-hidden">
                    ...
                    <span className="absolute model text-2xl">
                      Z 6III BODY ONLY
                      <span className=" text-6xl ml-1 mr-1">|</span>MRP Rs. 2 47
                      990.00
                    </span>
                  </div>
                </SwiperSlide>
                <SwiperSlide className="Slide">
                  ...
                  <div className="w-[70%] h-[80%] SwiperDiv flex items-center justify-center relative overflow-hidden">
                    ...
                    <span className="absolute  text-2xl model">
                      Z 8 + NIKKOR Z 28-75MM F/2.8 LENS
                      <span className=" text-6xl ml-1 mr-1">|</span>MRP Rs. 4 08
                      995.00
                    </span>
                  </div>
                </SwiperSlide>
                <SwiperSlide className="Slide relative">
                  ...
                  <div className="w-[70%] h-[80%] SwiperDiv flex items-center justify-center relative overflow-hidden">
                    ...
                    <span className="absolute model text-2xl">
                      Z 6II + NIKKOR Z 28-75MM F/2.8 LENS
                      <span className=" text-6xl ml-1 mr-1">|</span>MRP Rs. 2 24
                      995.00
                    </span>
                  </div>
                </SwiperSlide>
          ...
          <div className="absolute  left-[-50%] mr-[2rem]  hidden lg:flex flex-col gap-[1rem] items-center justify-center z-[100000] timer-slider">
            <div className="relative border border-gray-500 w-[50px] h-[50px] rounded-[50%] bg-transparent flex items-center justify-center timer">
              <div className="absolute bg-transparent w-[80%] h-[80%] rounded-full "></div>
