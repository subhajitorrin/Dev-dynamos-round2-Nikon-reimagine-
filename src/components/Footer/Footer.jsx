...
const Footer = () => {
  ...
  if (width > 768) {
    ...
    return (
      <div className="border-t border-t-[#ffffff53] FooterContainer m-0 max-h-[65vh] w-full flex flex-col items-center gap-5 justify-center relative z-[99] pt-[2rem] bg-transparent box-border">
