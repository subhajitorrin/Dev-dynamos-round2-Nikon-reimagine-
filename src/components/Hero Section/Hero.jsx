        ...
        <div className='w-full h-[100vh] bg-transparent relative text-white'>
            ...
            <div className='hero-footer relative lg:top-[10rem] flex items-center justify-between pl-[2em] pr-[2rem] w-full'>
                <div className='links flex'>
                    <a href=""><FaSquareFacebook className='tags' /></a>
                    <a href=""><FaInstagram className='tags' /></a>
                    <a href=""><FaLinkedin className='tags' /></a>
                    <a href=""><IoLogoYoutube className='tags' /></a>
                    <a href=""><BsTwitterX className='tags' /></a>
                </div>
                <div className='price-infor flex gap-[1rem] items-center justify-between'>
                    <div className='price'>
                        <h1 className='text-4xl font-bold '>{priceInfo[activeIndex].price}</h1>
                    </div>
                    <div className='info p-[10px]'>
                        <h3 className='text-[1.2rem] font-[500]'>{priceInfo[activeIndex].name}</h3>
